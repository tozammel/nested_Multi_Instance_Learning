...
def removeArabicNumbers (texts):
    texts = re.sub(r'[\u0660-\u0669]',' ',texts)
    return(re.sub(' {2,}', ' ', texts))

def removeFarsiNumbers (texts):
    texts = re.sub(r'[\u06f0-\u06f9]',' ',texts)
    return(re.sub(' {2,}', ' ', texts))
...
def removeDiacritics (texts):
    texts = re.sub(r'[\u0610-\u061a]|\u0640|[\u064b-\u065f]|\u0670|[\u06d6-\u06dc]|[\u06df-\u06e4]|[\u06e7-\u06e8]|[\u06ea-\u06ed]',' ',texts)
    return(re.sub(' {2,}', ' ', texts))
...
def fixAlifs (texts):
    return re.sub(u'\u0622|\u0623|\u0625|[\u0671-\u0673]|\u0675',u'\u0627',texts)
...
def cleanChars (texts):
    ...
    ## ones I'm dropping
    texts = re.sub(u'[\u00A0-\u0600]|[\u0600-\u0621]|[\u063b-\u0640]|[\u064b-\u065f]|[\u066a-\u067d]|[\u0700-\uFB4F]|[\uFB50-\uFDFF]|[\uFE00-\uFFFF]','',texts)
